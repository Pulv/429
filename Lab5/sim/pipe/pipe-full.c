...
{
    return ((if_id_next->icode) == (I_IADDQ) || (if_id_next->icode) == 
      (I_NOP) || (if_id_next->icode) == (I_HALT) || (if_id_next->icode) == 
...
{
    return ((if_id_next->icode) == (I_IADDQ) || (if_id_next->icode) == 
      (I_RRMOVQ) || (if_id_next->icode) == (I_ALU) || (if_id_next->icode)
...
long long gen_need_valC()
{
    return ((if_id_next->icode) == (I_IADDQ) || (if_id_next->icode) == 
      ...
      (if_id_next->icode) == (I_MRMOVQ) || (if_id_next->icode) == (I_JMP)
...
{
    return (((if_id_curr->icode) == (I_IADDQ) || (if_id_curr->icode) == 
        (I_ALU) || (if_id_curr->icode) == (I_RMMOVQ) || (if_id_curr->icode)
         == (I_MRMOVQ)) ? (if_id_curr->rb) : ((if_id_curr->icode) == 
...
{
    return (((if_id_curr->icode) == (I_IADDQ) || (if_id_curr->icode) == 
        (I_RRMOVQ) || (if_id_curr->icode) == (I_IRMOVQ) || 
